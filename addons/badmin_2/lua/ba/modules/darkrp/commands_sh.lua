...
term.Add('EntityOwnedBy', '# владеет этим #.')
...
term.Add('EventInvalid', '# недействительный ивент!')
term.Add('AdminStartedEvent', '# начал ивент # на #.')
...
term.Add('AdminAddedYourMoney', '# выдал вам $# на ваш кошелёк.')
term.Add('AdminAddedMoney', 'Вы выдали $# на кошелёк игрока #.')
...
term.Add('PlayerNotFound', 'Игрок # не найден.')
term.Add('AdminSetHealth', '# изменил здоровье игрока # до #.')
term.Add('AdminSetYourHealth', '# изменил ваше здоровье до #.')
term.Add('AdminSetArmor', '# изменил броню игрока # до #.')
term.Add('AdminSetYourArmor', '# изменил вашу броню до #.')
...
term.Add('AdminStartedEventVote', '# начал голосование за эвент.')
