...
SWEP.ViewModel = Model("models/weapons/2_shot_m3super90.mdl")	-- Weapon view model
SWEP.WorldModel = Model("models/weapons/3_shot_m3super90.mdl")	-- Weapon world model
