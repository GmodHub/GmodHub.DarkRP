...
SWEP.ViewModel = Model("models/weapons/2_smg_tmp.mdl")	-- Weapon view model
SWEP.WorldModel = Model("models/weapons/3_smg_tmp.mdl")	-- Weapon world model
...
SWEP.FireSound = Sound("Alt_Weapon_TMP.1")
SWEP.Recoil = 0.7
