...
SWEP.ViewModel = Model("models/weapons/2_pist_fiveseven.mdl")	-- Weapon view model
SWEP.WorldModel = Model("models/weapons/3_pist_fiveseven.mdl")	-- Weapon world model
