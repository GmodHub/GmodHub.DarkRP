...
resource.AddFile 'resource/fonts/PrototypeRus.ttf'
...
hook.Add('Initialize', 'serversecure initialization', function()
    ...
    if serversecure then
        ...
        if serversecure.EnableThreadedSocket then serversecure.EnableThreadedSocket(true) end -- receives packets from the game socket on another thread (as well as analyzing it)
