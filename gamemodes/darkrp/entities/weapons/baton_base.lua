...
function SWEP:Initialize()
	...
	local materialName = "rp/" .. self:GetClass()

	if cachedMaterials[materialName] then return end
	...
	cachedMaterials[materialName] = true
end
...
function SWEP:Deploy()
	...
	if SERVER then
		self:SetMaterial("!rp/" .. self:GetClass())
	end
...
function SWEP:PreDrawViewModel(vm)
	...
	for i = 9, 15 do
		vm:SetSubMaterial(i, "!rp/" .. self:GetClass())
	end
end
