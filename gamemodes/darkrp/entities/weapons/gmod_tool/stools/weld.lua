...
function TOOL:LeftClick(trace)
	...
	if (not IsValid(trace.Entity)) && trace.Entity:IsPlayer() or trace.Entity:IsWorld() then return false end

	-- If there's no physics object then we can't constraint it!
	if (SERVER && !util.IsValidPhysicsObject(trace.Entity, trace.PhysicsBone)) then print("no physobj") return false end
